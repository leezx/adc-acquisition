...
data (see adc_acquisition/ops_client.py for the live-verified endpoint/CQL
shapes). Shared by every job that acquires OPS data (Job 08/WIPO, Job 10/
EPO) — the response schema is identical regardless of which country-code
prefix (WO, EP, ...) a job's CQL queries filter to.
